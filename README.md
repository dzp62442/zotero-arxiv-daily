...
This fork is based on [TideDra/zotero-arxiv-daily](https://github.com/TideDra/zotero-arxiv-daily) and adds Discord forum output support on top of upstream architecture.

## Fork Delta

- Added `src/zotero_arxiv_daily/construct_discord.py` for Discord webhook posting.
